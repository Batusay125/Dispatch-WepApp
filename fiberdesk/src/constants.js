...
export const STATUS_COLORS={pending:"#f0a030",dispatched:"#4d8ef5","on-way":"#9b78f5","on-site":"#20c8b0","for-approval":"#f0a030",configuring:"#4d8ef5",activated:"#2dcc7a",done:"#2dcc7a",cancelled:"#f05555"};
export const STATUS_BG={pending:"#2a1805",dispatched:"#0d1535","on-way":"#1a1040","on-site":"#052220","for-approval":"#2a1a05",configuring:"#0d1535",activated:"#081e13",done:"#081e13",cancelled:"#2a0a0a"};
